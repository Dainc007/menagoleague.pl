  ...
  <section class="league-news">
    ...
    <div class="league-news-container">
      ...
      <div class="league-news-item">
        <img class="league-news-item-img" src="<?php echo e(url('/images/6.png')); ?>" alt="" />
    ...
    <div class="read-more-container">
      <?php for($i=1;$i<=5;$i++): ?>
        <div class="read-more-item">
          <img class="read-more-item-img" src="<?php echo e(url('/images/8.png')); ?>" alt="" />
...
<?php /**PATH C:\Users\Bartek\Desktop\KURS\Menagoleague.pl\resources\views/inc/news.blade.php ENDPATH**/ ?>