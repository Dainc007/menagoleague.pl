<nav class="navbar navbar-expand-lg navbar-light bg-white shadow-sm">
    <div class="container">
        ...
        <div class="nav-auth dropdown">
            ...
            <?php endif; ?>
            <?php else: ?>
            <a class="dropdown-link" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><?php echo e(auth()->user()->name); ?> <span class="material-icons"> arrow_drop_down
                </span></a>
            ...
            <div class="container">
                <div class="responsive-menu-content">
                    ...
                    <div class="r-menu">
                        ...
                        <div class="r-dropdown">
                            <button class="btn btn-r-menu r-dropdown-link" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><?php echo e(__('nav.mainNav.tablesAndFixtures')); ?><span class="material-icons"> arrow_right</span></button>
                        ...
                        <div class="r-dropdown">
                            <button class="btn btn-r-menu r-dropdown-link" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><?php echo e(__('nav.mainNav.society')); ?><span class="material-icons">
                                    arrow_right </span></button>
                            <div class="r-dropdown-menu">
                                <a class="dropdown-item" href="https://www.facebook.com/groups/230246767524306" target="_blank"><?php echo e(__('nav.mainNav.fbGroup')); ?></a>
                                <a class="dropdown-item" href="https://www.facebook.com/MenagoLeague" target="_blank"><?php echo e(__('nav.mainNav.fbFanPage')); ?></a>
                                <a class="dropdown-item" href="https://discord.com/invite/3Jkp3YcU?utm_source=Discord%20Widget&utm_medium=Connect" target="_blank"><?php echo e(__('nav.mainNav.discord')); ?> </a>
                                <a class="dropdown-item" href="#admin"><?php echo e(__('nav.mainNav.admin')); ?></a>
                            </div>
                        </div>
                        ...
                        <div class="r-nav-auth">
                            ...
                            <div class="r-nav-auth-logged-user">
                                ...
                                <div class="r-nav-auth-logged-user-settings">
                                    <a href="<?php echo e(route('user.account')); ?>"><span class="material-icons"> manage_accounts </span> <?php echo e(__('nav.settings')); ?></a>
...
</nav><?php /**PATH /Users/daniel/Documents/GitHub/Menagoleague.pl/resources/views/inc/mainNav.blade.php ENDPATH**/ ?>