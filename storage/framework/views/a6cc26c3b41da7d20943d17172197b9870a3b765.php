<div class="details">
    <div class="entity attack">
        ...
        <div><span class="squareNum"><?php echo e(rand(0, 100)); ?></span>
            <p>Crossing</p>
        </div>
        <div><span class="squareNum"><?php echo e(rand(0, 100)); ?></span>
            <p>Finishing</p>
    ...
    <div class="entity traits">
        ...
        <div>
            <p>Outside Foor Shot</p>
        </div>
        <div>
            <p>Chip Shot (AI)</p>
        </div>
        <div>
            <p>Preffered Foot: <span>Right</span></p>
        </div>
        <div>
            <span class="starNum">
                <img src="/images/icons/star.png" alt="">
                <p><?php echo e(rand(0, 5)); ?></p>
            </span>
            <p>Weak Foot</p>
        </div>
        <div>
        ...
        <div>
            ...
            <p>Work Rate <span>High/Medium</span></p>
        </div>
    </div>
</div>
