...
class Article extends Model
{
    ...
    public const ARTICLES = [
        ...
        [
            ...
            'content'   =>  'Zgodnie z najnowszymi doniesieniami, gracze za udział w sezonach kariery online w grze FIFA 22 będą mogli wygrać egzemplarz kolejnej odsłony gry (FIFA 23). Pozostaje czekać na oficjalne potwierdzenie i pełny regulamin konkursu.',
        ],
        ...
        [
            ...
            'content'   =>  'Oficjalnie: Polska Ekstraklasa przestaje być ligą zarezerwowaną dla graczy określających siebie jako „słabszych”.  W nadchodzącym sezonie wszystkie ligi mają ponownie startować z równej pozycji. Tym razem by uniknąć częstych wyników „8:0” graczom zostanie przedstawiona możliwość udziału na niższych szczeblach ligowych w danym kraju (Championship, Serie B, 2. Bundesliga, Lique 2).',
        ]
    ];
}
