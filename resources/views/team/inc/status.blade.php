        ...
        <div class="player-status-content">
            ...
            <div class="player-status-item">
                ...
                <a class="name" href="{{ route('players.show', ['player' => $player]) }}">
                    <img class="player-image" src="https://fifastatic.fifaindex.com/FIFA21/images/players/5/158023.png" alt="">
                    {{ $player->name }}
                </a>
                ...
                <div class="dropdown player-actions-container">
                    <button class="btn w-100 h-100 dropdown-toggle material-icons" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    </button>
